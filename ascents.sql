/*
Build tables for the data, and some views on top of that data.
*/

create table ascents (
    ascent_id serial primary KEY
    ,ascenionist varchar(100) not NULL
    ,gender boolean not null
    ,ascent_type varchar(20) not NULL
    ,grade varchar(6) not null
    ,ascent_names varchar(255) not NULL
    ,notes text
    ,year int
);

insert INTO ascents
    (ascenionist, gender, ascent_type, grade, ascent_names, notes, year)
...
VALUES
    ...
    ('Billy Ridal', '8B+','Never Ending Story, Superman SDS',,,2019),
    ...
    ('Ryan Pasquill', '8B',Cypher, The Ace, Shallow Groove,,,,),
